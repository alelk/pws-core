...
- `pws-android/docs/ai/plans/2026-06-18_pluggable-book-library_plan.md` — book catalog, download,
  import into Room, BookLibraryScreen (T-001/T-002 in pws-v2x-library-manager still TODO)

When the user says "look at the plan" without a name, **ask which one** or default to the book
library plan.
