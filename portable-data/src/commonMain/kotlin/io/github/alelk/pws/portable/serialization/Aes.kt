 ...
 *
 * SHA-256 and HMAC-SHA-256 are implemented in pure Kotlin in [Sha256.kt] (commonMain)
 * and do NOT need platform-specific implementations.
 *
 * - JVM: `javax.crypto` (built-in)
